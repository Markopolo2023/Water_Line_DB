...
**Water Line** is a effort to gather historical enterprise data into a system that integrates over 1,000 heterogeneous data sources—including PDFs, Excel files, DOCX documents, and handwritten reports dating back to 1970. The end goal is a unified and queryable SQLite and MSSQL databases for exploration and long term storage. Leveraging multiple Python libraries for OCR and data cleansing, AWS Textract services, AI APIs (Claude, Grok, ChatGPT), and extensive fine-tuning, this system transformed fragmented historical data into a clean, functional platform for data mining, decision support, and research. The unified databases enabled cost optimization, predictive analytics, and regulatory compliance across water treatment operations.
